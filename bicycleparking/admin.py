...
class Pictures(admin.ModelAdmin):
    ...
    def image_tag(self, obj):
        return format_html(
            '<a href="https://storage.googleapis.com/bikespace-yeg-photos/{}"><img src="https://storage.googleapis.com/bikespace-yeg-photos/{}" style="max-width: 400px; max-height: 400px"/></a>'.format(
